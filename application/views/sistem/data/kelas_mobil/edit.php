...
<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Edit Kelas Mobil
										</div>
									...
									<div class="portlet-body form">
											...
											<div class="form-body">
												...
												<div class="row">
													<input type="hidden" name="id_kelas_mobil" value="<?php echo $id_kelas_mobil;?>" >
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Kelas Mobil</label>
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="nama_kelas_mobil" value="<?php echo $nama_kelas_mobil;?>">
