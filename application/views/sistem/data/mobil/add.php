...
<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-gift"></i>Add Mobil
										</div>
												...
												<div class="row">
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<div class="col-md-6">
																<input type="text" class="form-control" placeholder="" name="nama_mobil">
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<div class="col-md-6">
																<input type="text" class="form-control" placeholder="" name="harga_mobil">
												...
												<div class="row">
													...
													<div class="col-md-12">
														<div class="form-group">
															...
															<div class="col-md-9">
																<textarea name="spesifikasi_mobil" id="spesifikasi_mobil"  rows="6" class="wysihtml5 form-control" ></textarea>
